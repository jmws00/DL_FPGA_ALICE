...
## LEDs
#set_property -dict { PACKAGE_PIN E18   IOSTANDARD LVCMOS33 } [get_ports { signal_out_0 }]; #IO_L16N_T2_A27_15 Sch=led[2]
...
## Pmod Header JA
set_property -dict { PACKAGE_PIN L17   IOSTANDARD LVCMOS33 } [get_ports { signal_out_0 }]; #IO_L4P_T0_D04_14 Sch=ja_p[1]
